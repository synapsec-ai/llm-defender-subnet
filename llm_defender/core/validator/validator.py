...
class SubnetValidator(LLMDefenderBase.BaseNeuron):
    ...
    async def set_weights(self):
        ...
        if not self.debug_mode: 
            ...
            if result:
                ...
                bt.logging.error(f"Failed to commit weights. Message: {commit_weights_message}")
    ...
    def reveal_weights(self, current_block):
        ...
        bt.logging.trace(f"commit_reveal_weights_interval: {commit_reveal_weights_interval}")
