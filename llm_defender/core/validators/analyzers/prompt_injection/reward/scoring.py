...
class PromptInjectionScoring:
    ...
    def get_response_object(
        ...
        response = {
            ...
            "response": {},
            "scored_response": PromptInjectionScoring.get_engine_response_object(),
    ...
    def calculate_subscore_distance(response, target) -> float:
        ...
        for _, engine_response in enumerate(response["engines"]):
            ...
            distance_scores.append(
                PromptInjectionScoring.calculate_distance_score(target, engine_response)
            )

        total_distance_score = PromptInjectionScoring.calculate_total_distance_score(distance_scores)
